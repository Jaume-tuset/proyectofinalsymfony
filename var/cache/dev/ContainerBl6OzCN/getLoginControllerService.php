...
class getLoginControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.uT.fSCP'] ?? $container->load('get_ServiceLocator_UT_FSCPService'))->withContext('App\\Controller\\LoginController', $container));
