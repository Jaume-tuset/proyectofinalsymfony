...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@WebProfiler/Collector/cache.html.twig", "/opt/lampp/htdocs/htdocs_examen/symfony/examenfinaljaume/vendor/symfony/web-profiler-bundle/Resources/views/Collector/cache.html.twig");
    }
}
