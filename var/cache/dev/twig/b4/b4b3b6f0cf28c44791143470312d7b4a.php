...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@WebProfiler/Collector/config.html.twig", "/opt/lampp/htdocs/htdocs_examen/symfony/examenfinaljaume/vendor/symfony/web-profiler-bundle/Resources/views/Collector/config.html.twig");
    }
}
