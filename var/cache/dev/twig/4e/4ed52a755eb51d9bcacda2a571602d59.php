...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "@Debug/Profiler/dump.html.twig", "/opt/lampp/htdocs/htdocs_examen/symfony/examenfinaljaume/vendor/symfony/debug-bundle/Resources/views/Profiler/dump.html.twig");
    }
}
